...
// here is the bug :
// https://ibb.co/g31FCYT

// the bug is that foodObj is an object so we cant use forEach.
// forEach works only for arrays , so to fix it we have to type foodObj.meats.forEach....
